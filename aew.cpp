...
/*---------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------*/
    ...
    cout<<"NAME :  "<<name<< "\t\t\tNUMBER ROOM : "<< number_room<<"\n";
    cout<<"TYPE ROOM : ";
        if(type_room==1)      cout<<"SMALL ROOM"; 
        else if(type_room==2) cout<<"BOUBLE BED";
        else                  cout<<"BIG ROOM";
 
    
    cout<<"\t\tTOTAL PRICE : "<<room_price *num_day <<" BATH\n";
    cout<<"NUMBER DAY : "<<num_day <<" DAY";
